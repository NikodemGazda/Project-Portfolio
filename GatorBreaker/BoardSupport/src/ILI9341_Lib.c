...
{
    LCD_DrawRectangle(Xpos,Ypos,1,1,color);
}
...
{
    LCD_DrawRectangle(0,0,240,320,color);
...
/*******************************************************************************
 * Function Name  : LCD_Fix
 * Description    : Stop the screen from inverting
 * Input          : None
 * Output         : None
 * Return         : None
 * Attention      : None
