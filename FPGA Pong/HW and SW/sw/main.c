...
#define BALL_X_OUTADDR (uint32_t*)XPAR_IMAGE_GEN_2_AXI_0_S00_AXI_BASEADDR
#define BALL_Y_OUTADDR (uint32_t*)XPAR_IMAGE_GEN_2_AXI_0_S00_AXI_BASEADDR + 1
#define LPADDLE_Y_OUTADDR (uint32_t*)XPAR_IMAGE_GEN_2_AXI_0_S00_AXI_BASEADDR + 2
#define RPADDLE_Y_OUTADDR (uint32_t*)XPAR_IMAGE_GEN_2_AXI_0_S00_AXI_BASEADDR + 3
#define RSCORE_OUTADDR (uint32_t*) XPAR_IMAGE_GEN_2_AXI_0_S00_AXI_BASEADDR + 4
#define LSCORE_OUTADDR (uint32_t*) XPAR_IMAGE_GEN_2_AXI_0_S00_AXI_BASEADDR + 5
// Enumerations
// State Machine
typedef enum {
    RESET,
